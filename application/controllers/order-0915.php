...
class Order extends CI_Controller{
	...
	public function ajaxOrderFormFind(){
		...
		// $aColumns=array("order_id","order_id","form_psss","form_psss1","client_name","client_cell_phone","client_address","form_psss1","lastTime","client_agent","client_ctime","client_id");
		// $aColumns=array("order_id","order_id","form_psss","form_psss1","client_name","client_cell_phone","client_address","form_psss1","lastTime","client_agent","client_ctime","order_id");
		$aColumns=array("order_id","order_id","form_psss","form_sssh","form_name","form_cell_phone1","form_cell_phone2","form_psss1","lastTime","form_agent","form_send_time","order_id");
