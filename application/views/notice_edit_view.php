...
<div class="page_main page_tops">
    <div class="page_nav">
         ...
         <div class="nav_">当前位置：&gt; 公告</div>
         <div class="nav_other"></div>
	</div>
    <div class="func-panel" style="width:100%;height:23px"></div>
	<div class="work-list">
    <?php echo form_open(site_url("notice/".$dst)) ?>
    	<table style="margin-left:30px;margin-top:30px;">
        	<tr><td align="center">标题</td><td><input type="text" name='title' value="<?php echo isset($notice)?$notice[0]['notice_title']:'';?>" width="100%"></td></tr>
            <tr><td align="center">内容</td>
            	<td><textarea id="editor_id" name="content" style="width:700px;height:240px;">
                    	<?php  echo isset($notice)?$notice[0]['notice_html']:"";?>
					</textarea>
                </td>
            </tr>
