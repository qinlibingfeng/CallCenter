    ...
    <?php foreach ($items as $item){?> 
		<div class=gFd>
    	  <h3 class="gfTit" onmouseover="javascript:showDivMenu('study_<?php echo $item["item_id"]?>'); showFoldClass('fold_<?php echo $item["item_id"]?>');" onmouseout="javascript:hideDivMenu('study_<?php echo $item["item_id"]?>')">
             ...
             <img  src="images/lgq-lll.gif" width=100% height=33px><a href="javascript:void(0);" style="display:hidden" class="gfName" hidefocus="true"><?php echo $item["item_text"];?></a></img>
          </h3>       
			...
			<img src="images/lgq-lll.gif" width=128px height=33px>
