...
$(document).ready(function() {	
	...
	createTables=function (filterString){
		$('#dataList').dataTable( {
			...
			"sAjaxSource": "<?php echo site_url('report/ajaxReportCustomClientCount')?>",
			"oLanguage": {
	...
	$("#btnExport").click(function(){
		 ...
		 $("#csvUrl").html("");
		 $.post("<?php echo site_url('export/ajaxCustomClientCountExport')?>",req,function(res){	
   ...
   <div id="example" >
           <table width="100%" cellpadding="0" cellspacing="0" border="0"  id="dataList" >
          		<thead>   
                    ...
                    <th align="left">日期</th>
                    <?php foreach($headerFileds as $value){
