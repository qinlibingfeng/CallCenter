...
.dataTables_length{display:none}
    ...
    <script>	
		...
		$(document).ready(function(){
			...
			var datas={'form_name':'','form_cell_phone1':'','form_cell_phone2':'','form_psss':'',
			'form_psss1':'','form_monen':'','form_shishou':'','form_send_time':'','form_send_way':'','form_express_num':''};
	
				datas.form_name=$('#form_name').attr('value');
				datas.form_cell_phone1=$('#form_cell_phone1').attr('value');
				datas.form_cell_phone2=$('#form_cell_phone2').attr('value');
				datas.form_psss=$('#form_psss').attr('value');
				datas.form_psss1=$('#form_psss1').attr('value');
				datas.form_monen=$('#form_monen').attr('value');
				datas.form_shishou=$('#form_shishou').attr('value');
				datas.form_send_time=$('#form_send_time').attr('value');
				datas.form_send_way=$('#form_send_way').attr('value');
				datas.form_express_num=$('#form_express_num').attr('value');
				datas.order_id=$('#order_id').attr('value');

				
	
				$.post("<?php echo site_url('order/ajaxOrderStatus')?>",datas,function(res){	
					 if(res.ok){
					 	alert('成功保存');
					 }else
					 {
	...
	<div class="page_nav">
     ...
     <div  class="func-panel">
			...
			<div  class='tabs' style="padding-left:40px">		
				<ul class="idTabs">       	 
                	<li><a href="#bussniessInfo">订单信息</a></li>	       	          
					<li><a style="display:none" href="#connectInfo">沟通记录</a></li> 	
                    <li><a style="display:none" href="#helprDoc"> 知识库</a></li>  	                   
				</ul> 
			</div>
			<br>
			<br>
			<div style="display:none" id="personInfo" class="panelOne">
