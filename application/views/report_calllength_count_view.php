...
$(document).ready(function() {	
	...
	createTables=function (filterString){
		$('#dataList').dataTable( {
			...
			"sAjaxSource": "<?php echo site_url('report/ajaxReportCallLengthCount')?>",
			"oLanguage": {
   ...
   <div id="example" >
           <table width="100%" cellpadding="0" cellspacing="0" border="0"  id="dataList" >
          		<thead>   
                    ...
                    <th align="left">日期</th>
                    <th align="left">&lt=5</th>
                    <th align="left">&gt5&lt=10</th>
                    <th align="left">&gt10&lt=15</th>
                    <th align="left">&gt15&lt=20</th>
                    <th align="left">&gt20&lt=25</th>
                    <th align="left">&gt16&lt=30</th>
                    <th align="left">&gt30&lt=60</th>
                    <th align="left">&gt60 &lt=90</th>
                    <th align="left">&gt90</th>
                    <th align="left">总时长</th>
