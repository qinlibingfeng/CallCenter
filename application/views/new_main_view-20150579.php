...
<div id="divLeftMenu" class="gMain">
  <div class="gLe" id="Menu_List">
    ...
    <?php foreach ($items as $item){?> 
		<div class=gFd>
    	    <h3 class="gfTit" onmouseover="javascript:showDivMenu('study_<?php echo $item["item_id"]?>');showFoldClass('fold_<?php echo $item["item_id"]?>');">
        	   <!--<a href="javascript:void(0);" id="fold_<?php echo $item["item_id"]?>" rel="fold" class="opnFd bgF1" title="开启" hidefocus="true"></a>-->
             <img src="images/lgq-lll.gif" width="128" height="29"><a href="javascript:void(0);" color:white; class="gfName" hidefocus="true"><?php echo $item["item_text"];?></a></img>
          </h3>       
			...
			<img src="images/lgq-lll.gif" width="128" height="29">
