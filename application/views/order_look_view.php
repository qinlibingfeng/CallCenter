...
$(document).ready(function() {
	...
	function getSearchString(){	
		...
		var row=[{'dbtype':'varchar','id':'order_group','type':2},{'dbtype':'varchar','id':'order_status','type':2}];
	...
	createTables=function (filterString){
		$('#dataList').dataTable( {
			...
			"fnCreatedRow": function( nRow, aData, iDataIndex ) {	
			 	//var htmlStr='<center><a href="javascript:onProcessOrder(\''+aData[10]+'\')"><img src="www/images/dxzx.png"></img></a></center>';
				
			 	//$('td:eq(10)', nRow).html(htmlStr);
			},
...
<div class="page_main page_tops">
  ...
  <?php echo form_dropdown('e_hour',$endTime['hourOptions'],$endTime['hourDef'],'id="e_hour"')?><?php echo form_dropdown('e_min',$endTime['minOptions'],$endTime['minDef'],'id="e_min"')?>
  				工单状态<select id="order_status"></select>
                工单类型<select id="order_group"></select>
